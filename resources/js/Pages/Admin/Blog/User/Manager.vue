            ...
            <div  class="mt-12">
                <div class="space-y-12">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3 sm:border-b sm:border-gray-800 ">
                        <div>
                            <h4 class="text-lg font-semibold leading-6 text-white">Definições de usuário</h4>
                            <p class="mt-1 text-sm text-gray-400">
                                Utilize essa seção para criar um usuário.
                            </p>
                        </div>
                            ...
                            <div class="col-span-full">
                                <div>
                                    ...
                                    <div class="mt-1 rounded-md shadow-sm">
                                        ...
                                        <input v-model="form.password" id="password" type="text" name="password" placeholder="Informe a senha do usuário" class="mt-1 block w-full transition duration-150 ease-in-out  border border-gray-700 placeholder-gray-400 text-gray-200 font-medium rounded-md bg-gray-900 shadow-sm focus:outline-none  focus:border-blue-500 sm:text-sm sm:leading-5" />
                                    </div>
